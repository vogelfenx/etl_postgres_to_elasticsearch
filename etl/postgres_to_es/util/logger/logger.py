...
class Logger:
    ...
    def __init__(self, log_filepath: str = None, message_format: str = None, level: int = logging.ERROR):
        ...
        logging.basicConfig(filename=log_filepath, format=message_format, level=level)
